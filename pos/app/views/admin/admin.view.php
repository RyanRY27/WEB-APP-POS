...
<div class="pt-4 container-fluid row">
	<div class="col-12 col-sm-4 col-md-3 col-lg-2">
		<div class="list-group">
			...
			<a href="index.php?page=admin&tab=reports" class="list-group-item list-group-item-action <?=$tab=='reports'?'active':''?>"><i class="fa-solid fa-file-circle-check ms-2 me-2" style="color: #000000;"></i>Reports</a>
